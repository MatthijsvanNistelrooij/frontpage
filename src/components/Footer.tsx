...
export const Footer = () => <footer className="bg-[#171714] px-5 pb-8 pt-20 text-white md:px-8 md:pt-32"><div className="mx-auto max-w-[1600px]">
  ...
  <Link href="/contact" className="group block border-b border-white/20 pb-10"><span className="display block max-w-6xl">Iets moois in beweging zetten?</span><span className="mt-8 inline-block text-lg text-[#ff4d00] group-hover:underline">Vertel me wat er speelt ↗</span></Link>
