...
import breinoptimaal_2 from "/public/assets/breinoptimaal/breinoptimaal_header.jpg"
    ...
    <>
      <div className="relative w-full h-[60vh] lg:h-[95vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <h1
            className="text-white text-6xl px-8 md:text-[6rem] lg:text-[6rem] text-center drop-shadow-lg max-w-3xl lg:max-w-5xl mb-10 font-[420]"
