    ...
    <>
      <div className="relative w-full h-[60vh] lg:h-screen">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <h1 className="text-white text-5xl px-8 md:text-8xl lg:text-[7rem] text-center drop-shadow-lg max-w-3xl lg:max-w-5xl mb-10">
      ...
      >
        <div className="container mx-auto px-8 py-12">
          ...
          >
            Wij zijn een creatief bedrijf dat vernieuwende oplossingen inzet in
            combinatie met design, techniek en strategie om projecten te
            realiseren die werken en vertrouwen uitstralen. Of het nu gaat om
            een merk dat zich duidelijk wil onderscheiden, een website die
            intuïtief is, of een app die echt iets toevoegt – wij vinden de
            slimme, doordachte aanpak. En dat doen we met aandacht en liefde.😉
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-28 md:gap-8">
            ...
            <ProjectCard
              url="restaurant"
              info="Een moderne, frisse landing met een custom design om Restaurant Four Seasons op de kaart te zetten."
              title="Restaurant Four Seasons"
              image={four_seasons_restaurant}
              hoverImage={four_seasons_logo}
            />
          </div>
          <div className="text-center mt-40 mb-10 text-4xl md:text-5xl text-black">
